...
export function SiteFooter() {
  ...
  async function onSubscribe(data: NewsletterValues) {
    setSubmitting(true);
    setSubmitError(null);
    setSubmitted(false);
    try {
    ...
    <footer className="relative bg-navy text-white overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1600px] px-8 py-16 md:px-16 lg:px-20">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
          ...
          <div className="max-w-sm">
            ...
            <address className="not-italic">
              ...
              <div className="mt-5 flex flex-col gap-2 text-sm font-medium text-white/80">
                ...
                <a
                  href="tel:+243833843380"
                  className="transition hover:text-gold"
                >
                  +243 833 843 380
                </a>
                <a
                  href="tel:+254791564429"
                  className="transition hover:text-gold"
                >
                  +254 791 564 429
                </a>
          ...
          {/* Quick links */}
          <div>
            <h2 className="text-[11px] font-semibold uppercase tracking-[0.2em] text-gold mb-5">
              {dict.footer.explore}
            </h2>
            <nav className="flex flex-col gap-3">
              <a
                href="#how-we-work"
                className="text-sm font-light text-white/60 transition hover:text-white hover:pl-1"
              >
