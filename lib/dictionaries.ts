...
const en: Dictionary = {
  hero: {
    ...
    gold: {
      ...
      title: "Start Smart with Nyumbani Gold",
      description:
...
const fr: Dictionary = {
  hero: {
    platinum: {
      tagline: "Nyumbani Platinum",
      title: "Possédez Nyumbani Platinum",
      description:
    ...
    gold: {
      tagline: "Nyumbani Gold",
      title: "Commencez malin avec Nyumbani Gold",
      description:
  ...
  footer: {
    ...
    subscribing: "Envoi...",
    subscribeFailed:
      "Nous n'avons pas pu soumettre votre e-mail pour le moment. Veuillez reessayer.",
